...
import 'package:foodpanda_sellers_app/mainScreens/parcel_in_progress_screen.dart';
  ...
  getPerParcelDeliveryAmount() {
    FirebaseFirestore.instance
      ...
      if (snap.exists) {
        ...
        // Eğer belirtilen doküman bulunamazsa veya değeri null ise, başka bir işlem yapılabilir.
      }
    });
  }
